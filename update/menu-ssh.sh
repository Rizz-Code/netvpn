...
OWNER=$(curl -sS https://accessvpn.onrender.com | grep $MYIP | awk '{print $2}')
...
wget -q -O /usr/bin/proxy3.js "https://raw.githubusercontent.com/rizz-code/netvpn/main/ssh/proxy3.js"
...
echo -e "\033[1;36m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[0m" 
wget -q -O /usr/bin/ssh-wsenabler "https://raw.githubusercontent.com/rizz-code/netvpn/main/ssh/sshws-true.sh" && chmod +x /usr/bin/ssh-wsenabler
